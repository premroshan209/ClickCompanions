...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  await sendEmail({
    email: newUser.email, subject: "OTP for ClickCompanions!", message: `Your OTP for email verification is \n ${otp}.`
  });
...
exports.verifyEmail = catchAsync(async (req, res, next) => {
  ...
  if (user.emailVerificationOtp === emailVerificationOtp) {
    ...
    await sendEmail({
      email: user.email, subject: "Welcome to ClickCompanions!", message: `Dear user,\nWelcome to ClickCompanions. Your Registration is successfull.`
    });
